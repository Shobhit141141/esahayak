  ...
  return (
    <Card shadow="sm" padding="lg" radius="md" style={{ maxWidth: 400, margin: "2rem auto" }}>
      ...
      <form onSubmit={handleSubmit}>
        <TextInput label="Name" value={form.name} onChange={(e) => handleChange("name", e.target.value)} required mb="md" />
        <TextInput label="Email" value={form.email} onChange={(e) => handleChange("email", e.target.value)} required mb="md" />
        <Select
          label="Role"
          data={[
